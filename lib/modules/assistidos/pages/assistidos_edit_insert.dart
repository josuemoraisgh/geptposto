...
class AssistidoEditInsert extends StatefulWidget {
  late final Assistido _assistido;
  late final bool isAdd;
  late final RxNotifier<File?> imageFile;
  AssistidoEditInsert({Key? key, Assistido? assistido, required this.imageFile})
      : super(key: key) {
  ...
  @override
  State<AssistidoEditInsert> createState() => _AssistidoEditInsertState();
}

class _AssistidoEditInsertState extends State<AssistidoEditInsert> {
