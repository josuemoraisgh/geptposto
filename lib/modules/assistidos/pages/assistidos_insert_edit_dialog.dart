...
class AssistidosInsertEditDialog extends StatefulWidget {
  ...
  const AssistidosInsertEditDialog(
      {Key? key, this.assistido, required this.store, required this.function})
      : super(key: key);

  @override
  State<AssistidosInsertEditDialog> createState() =>
      _AssistidosInsertEditDialogState();
}

class _AssistidosInsertEditDialogState
    extends State<AssistidosInsertEditDialog> {
  late bool isAdd;
                  ...
                  onPressed: assistido!.nomeM1.length > 4
                      ? () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (isAdd) {
                              widget.store.add(assistido);
                            } else {
                              widget.store.setRow(assistido!);
                            }
                          }
                          Modular.to.pop();
                        }
            ...
            content: SingleChildScrollView(
              ...
              children: [
                ...
                TextFormField(
                    ...
                    validator: (value) => null,
                    onChanged: (v) =>
                        setState(() => assistido!.complemento = v)),
                TextFormField(
